 ...
 */
export default function RichText({attributes, children, className, dropCap = false, id, style, tag = 'div'}) {
  const tagClassName = tag !== 'div' ? tag : ''
  return React.createElement(tag, {
    ...attributes,
    className: cn(styles.richtext, styles?.[tagClassName], dropCap && styles.dropcap, className),
    id: id || null,
