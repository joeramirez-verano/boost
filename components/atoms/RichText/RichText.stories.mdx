...
<Meta title="Inactive/Atoms/RichText" component={RichText} />
...
<Canvas>
  <Story name="Component">
    <RichText>{`<p>Example mixed content <strong>with bold text</strong> and <a href="https://example.com">linked content</a>.</p>`}</RichText>
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Tag">
    <RichText tag="h2">{`This heading has <strong>Bold Content</strong> and <i>Italics</i>`}</RichText>
  </Story>
</Canvas>
