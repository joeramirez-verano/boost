    ...
    return (
      <>
        {isStorybook ? (
          ...
          <img {...imageProps} className={cn(props?.nextImageFill ? styles.imageFill : null, props.className)} unoptimized />
        ) : (
          // eslint-disable-next-line
          <img {...imageProps} className={cn(props?.nextImageFill ? styles.imageFill : null, props.className)} />
        )}
      </>
    )
  }
